<div class="bg-white rounded-lg overflow-hidden shadow-md animal-card" data-filter="<?php echo $animal_tax_list; ?>">
	<div class="p-10 font-body text-lightgray pt-4">
		<h1 class="font-display text-3xl font-bold mb-4">
			...
			<?php echo get_sub_field('city_name'); ?>
		</h1>
		<p class="align-center flex"><i class="fas fa-globe-americas text-yellow text-2xl mr-2"></i><span class="underline">email@email.email</span></p>
		<p class="align-center flex mt-2"><i class="fas fa-phone-alt text-yellow text-2xl mr-2"></i><span class="underline">555-555-5555</span></p>
